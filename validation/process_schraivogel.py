...
df_pos = pd.read_csv("data/validation/schraivogel_positive.tsv", sep="\t")
df_pos.drop_duplicates(inplace=True)
df_neg = pd.read_csv("data/validation/schraivogel_all.tsv", sep="\t")
...
df.to_csv("data/validation/schraivogel_processed.tsv", index=False, sep="\t")